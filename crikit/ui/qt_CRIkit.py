...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/open-iconic-master/png/bug-3x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionScaleErrorCorrection.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/open-iconic-master/png/graph-3x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAmpErrorCorrection.setIcon(icon20)
...
"This will be saved to the processed file."))
        ...
        self.actionAmpErrorCorrection.setText(_translate("MainWindow", "Baseline Detrending"))
