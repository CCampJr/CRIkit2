...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionToolBarNIST = QtWidgets.QAction(MainWindow)
        self.actionToolBarNIST.setCheckable(True)
        self.actionToolBarNIST.setChecked(False)
        self.actionToolBarNIST.setObjectName("actionToolBarNIST")
        ...
        self.menuToolbar.addAction(self.actionToolBarNIST)
...
"This will be saved to the processed file."))
        ...
        self.actionToolBarNIST.setText(_translate("MainWindow", "NIST CRI Workflow"))
