...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLoad_NRB_Blue_Side = QtWidgets.QAction(MainWindow)
        self.actionLoad_NRB_Blue_Side.setObjectName("actionLoad_NRB_Blue_Side")
        self.actionLoad_NRB_Red_Side = QtWidgets.QAction(MainWindow)
        self.actionLoad_NRB_Red_Side.setObjectName("actionLoad_NRB_Red_Side")
        self.actionNRB_from_ROI_Blue_Side = QtWidgets.QAction(MainWindow)
        self.actionNRB_from_ROI_Blue_Side.setObjectName("actionNRB_from_ROI_Blue_Side")
        self.actionNRB_from_ROI_Red_Side = QtWidgets.QAction(MainWindow)
        self.actionNRB_from_ROI_Red_Side.setObjectName("actionNRB_from_ROI_Red_Side")
        ...
        self.menuPiece_wise_NRB.addAction(self.actionLoad_NRB_Blue_Side)
        self.menuPiece_wise_NRB.addAction(self.actionNRB_from_ROI_Blue_Side)
        self.menuPiece_wise_NRB.addSeparator()
        self.menuPiece_wise_NRB.addAction(self.actionLoad_NRB_Red_Side)
        self.menuPiece_wise_NRB.addAction(self.actionNRB_from_ROI_Red_Side)
...
"This will be saved to the processed file."))
        ...
        self.actionLoad_NRB_Blue_Side.setText(_translate("MainWindow", "Load NRB (HDF; Blue-Side)"))
        self.actionLoad_NRB_Red_Side.setText(_translate("MainWindow", "Load NRB (HDF; Red-Side)"))
        self.actionNRB_from_ROI_Blue_Side.setText(_translate("MainWindow", "NRB from ROI (Blue-Side)"))
        self.actionNRB_from_ROI_Red_Side.setText(_translate("MainWindow", "NRB from ROI (Red-Side)"))
